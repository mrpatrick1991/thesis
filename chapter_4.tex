...
\begin{figure}[p]
    \centering
    \includegraphics[\textwidth]{figures/chapter_4/l-curve-example/L_curve_example_5.pdf}
...
\begin{figure}[p]
    \centering
    \includegraphics[\textwidth]{figures/chapter_4/cross-validation-example/cross_validation_example.pdf}
